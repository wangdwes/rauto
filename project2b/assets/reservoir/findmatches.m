...
%  [locs1, locs2] = deal(vpts1.Location(matches(:, 1), :), vpts2.Location(matches(:, 2), :)); 
  ...
  [bestf, inliers] = ransacf(locs1, locs2, 500, 1e-3);
%  [bestf, inliers] = estimateFundamentalMatrix(locs1, locs2, 'Method', 'RANSAC');
