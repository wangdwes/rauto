...
% ##########
% q5 ellipse with heading control
n = 9;
r = 4;
tauseg = 3;
tau = [0; 2*tauseg; tauseg; tauseg; tauseg; ...
       tauseg; tauseg; tauseg; tauseg; ...
       tauseg; tauseg; tauseg; tauseg; ...
       tauseg; tauseg; tauseg; tauseg; ...
       tauseg; tauseg; tauseg; 1.5*tauseg];
wpx = [0, 0, 0, 0, 0; % Lap 1
       2, 0, NaN, NaN, NaN;
       0, NaN, NaN, NaN, NaN;
       -2, 0, NaN, NaN, NaN;
       0, 1, NaN, NaN, NaN; % Lap 2
       2, 0, NaN, NaN, NaN;
       0, NaN, NaN, NaN, NaN;
       -2, 0, NaN, NaN, NaN;
       0, 1, NaN, NaN, NaN; % Lap 3
       2, 0, NaN, NaN, NaN;
       0, NaN, NaN, NaN, NaN;
       -2, 0, NaN, NaN, NaN;
       0, 1, NaN, NaN, NaN; % Lap 4
       2, 0, NaN, NaN, NaN;
       0, NaN, NaN, NaN, NaN;
       -2, 0, NaN, NaN, NaN;
       0, 1, NaN, NaN, NaN; % Lap 5
       2, 0, NaN, NaN, NaN;
       0, NaN, NaN, NaN, NaN;
       -2, 0, NaN, NaN, NaN;
       0, 0, NaN, NaN, NaN];
wpy = [0, 0, 0, 0, 0; % Lap 1
       ...
       2, 0, NaN, NaN, NaN;
       1, NaN, NaN, NaN, NaN;
       0, 0, NaN, NaN, NaN; % Lap 2
       1, NaN, NaN, NaN, NaN;
       2, 0, NaN, NaN, NaN;
       1, NaN, NaN, NaN, NaN;
       0, 0, NaN, NaN, NaN; % Lap 3
       1, NaN, NaN, NaN, NaN;
       2, 0, NaN, NaN, NaN;
       1, NaN, NaN, NaN, NaN;
       0, 0, NaN, NaN, NaN; % Lap 4
       1, NaN, NaN, NaN, NaN;
       2, 0, NaN, NaN, NaN;
       1, NaN, NaN, NaN, NaN;
       0, 0, NaN, NaN, NaN; % Lap 5
       1, NaN, NaN, NaN, NaN;
       2, 0, NaN, NaN, NaN;
       1, NaN, NaN, NaN, NaN;
       0, 0, NaN, NaN, NaN];
   
px = mwpsolver(n, r, [wpx, tau]);
py = mwpsolver(n, r, [wpy, tau]);
[trajxy, t_traj] = mwptraj({px, py}, tau);

traj = [trajxy{1}; trajxy{2}; ones(1, length(t_traj))];

% For heading control
ellipse_center = [0; 1; 1];
vref0 = [0; -1; 0]; % Center to origin
vref1 = [2; 0; 0]; % Center to first waypoint

% Pirouette
vpos = bsxfun(@minus, traj, ellipse_center); % Matrix whose columns are pos vectors
% An extremely hacky way to calculate angle between pos vector and origin vector
% (negate if angle between pos vector and wp1 vector is greater than 90
% -> pos on the side of wp3...)
trajheading = cellfun(@(c) -2 * ((acos(c'*vref1 / (norm(c)*norm(vref1))) > pi/2) - 0.5) * acos(c'*vref0 / (norm(c)*norm(vref0))), num2cell(vpos, 1));
...
for i = 1:samples
    ...
    if odom_idx > 1 && imu_idx > 1 && odom_updated && imu_updated
        ...
        switch c_state
            ...
            case sTRACKING
                if sqrt((pos_odom(:,odom_idx-1)-traj(:,end))'*(pos_odom(:,odom_idx-1)-traj(:,end))) < 0.05 && ...
        ...
        switch c_state
            ...
            case sTRACKING % Track the expected position at this time
                nextind = sum(t_traj < toc(tstart)-t_trajstart);
                pos_des = traj(:, nextind);
                att_des(3) = trajheading(nextind);
